	   ...
	   public static Result saveInventory() throws IOException {
	    	if(session("USER_KEY") == null || session("USER_KEY") == "") {
		    	...
		    	if(inventoryObj == null) {
			    	...
			    	inventory.cost = Double.parseDouble(vm.cost);
			    	inventory.price = Double.parseDouble(vm.price);
	   ...
	   public static void sendEmailToBrandFollowers(String brand) {
	    ...
	    public static Result getInventoryById(Long id) {
	    	if(session("USER_KEY") == null || session("USER_KEY") == "") {
				...
				inventoryVm.cost = String.valueOf(inventory.getCost());
				inventoryVm.price = String.valueOf(inventory.getPrice());
	    ...
	    public static Result updateInventoryById() throws SocketException, IOException{
	    	if(session("USER_KEY") == null || session("USER_KEY") == "") {
		    	...
		    	if(inventory != null) {
		    		...
		    		inventory.setCost(Double.parseDouble(vm.cost));
		    		inventory.setPrice(Double.parseDouble(vm.price));
