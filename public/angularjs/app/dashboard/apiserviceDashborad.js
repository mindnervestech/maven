...
.service('apiserviceDashborad', function($http,$q,$upload){
	...
	this.getAllParentAndChildCollection = function(){
		var defer = $q.defer();
		$http.get('/getAllParentAndChildCollection').success(function(data) {
			defer.resolve(data);
		});
	...
	this.getAllInventory = function(){
		var defer = $q.defer();
		$http.get('/getAllInventory').success(function(data) {
			defer.resolve(data);
		});
		return defer.promise;
	};
	...
	this.getUserAppointment = function(bestDt,bestTm,bestEndTm){
		var defer = $q.defer();
		$http.get('/getUserAppointment/'+bestDt+"/"+bestTm+"/"+bestEndTm).success(function(data) {
			defer.resolve(data);
		});
	...
	this.getAllVehical = function(){
		var defer = $q.defer();
		$http.get('/getAllVehical').success(function(data) {
			defer.resolve(data);
		});
	...
	this.getcommentLike = function(){
		var defer = $q.defer();
		$http.get('/getcommentLike').success(function(data) {
			defer.resolve(data);
		});
	...
	this.getPlanMsg = function(){
		var defer = $q.defer();
		$http.get('/getPlanMsg').success(function(data) {
			defer.resolve(data);
		});
	...
	this.getUpdateMeeting = function(){
		var defer = $q.defer();
		$http.get('/getUpdateMeeting').success(function(data) {
			defer.resolve(data);
		});
	...
	this.getaccepted = function(){
		var defer = $q.defer();
		$http.get('/getaccepted').success(function(data) {
			defer.resolve(data);
		});
	...
	this.getdecline = function(){
		var defer = $q.defer();
		$http.get('/getdecline').success(function(data) {
			defer.resolve(data);
		});
	...
	this.getdeleteMeeting = function(){
		var defer = $q.defer();
		$http.get('/getdeleteMeeting').success(function(data) {
			defer.resolve(data);
		});
	...
	this.getinvitationMsg = function(){
		var defer = $q.defer();
		$http.get('/getinvitationMsg').success(function(data) {
			defer.resolve(data);
		});
	...
	this.saveNoteOfUser = function(notOnject){
		var defer = $q.defer();
		$http.post('/saveNoteOfUser',notOnject).success(function(data) {
			$.pnotify({
			    title: "Success",
			    type:'success',
