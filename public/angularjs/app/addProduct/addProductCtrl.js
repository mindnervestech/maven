...
.controller('addProductCtrl', ['$scope','$http','$location','$filter','$routeParams','$upload', function ($scope,$http,$location,$filter,$routeParams,$upload) {
	...
	$scope.collectionList = function(){
		...
		.success(function(data) {
			...
			console.log($scope.proCollection);
			console.log($scope.readyCollection);
			//console.log($scope.sectionCollection);
		});
